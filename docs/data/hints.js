...
export const HINTS = {
  ...
  figure_out_basement: [
    ...
    "There's a cat watching everything from a dry shelf. She was here when it happened.\n書架上有隻貓,正安靜地看著這一切,事發時她就在場。",
    "Select Talk, then click Leafpool, and ask her about the crate.\n選擇「交談」,然後點擊葉池,問她關於木箱的事。",
  ],
  talk_to_leafpool: [
    "Someone down here might know what happened to the crate.\n這裡應該有人知道那個木箱發生了什麼事。",
    "There's a cat sitting near the shelf — try the Talk verb on her.\n書架附近坐著一隻貓——試著對她使用「交談」指令。",
    "Select Talk, then click Leafpool. Ask her about both the crate and the water.\n選擇「交談」,然後點擊葉池。問她關於木箱和積水的事。",
  ],
  examine_tablet: [
    "Leafpool had a theory about where that hum was coming from.\n葉池對那陣嗡嗡聲的來源有個想法。",
    "She pointed toward the etched tablet on the back wall.\n她指向後牆上那塊刻字石板。",
    "Select Look, then click the etched tablet again now that you know where to look.\n選擇「查看」,現在你知道該看哪裡了,再點一次那塊刻字石板。",
  ],
  find_the_chart: [
    "Something else washed up down here besides floodwater.\n這裡沖上來的,不只是積水而已。",
...
export const HINT_TARGETS = {
  ...
  figure_out_basement: { room: "subbasement", targets: ["leafpool"] },
  talk_to_leafpool: { room: "subbasement", targets: ["leafpool"] },
